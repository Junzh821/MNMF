...
def get_ArgumentParser():
    ...
    parser.add_argument("--DATA_DIR", default="cornell")
    ...
    parser.add_argument("--ALPHA", default=0.5, help="Similarity matrix factorization weight")
    ...
    parser.add_argument("--GAMMA", default=3.0, help="Modularity Maximization weight")
