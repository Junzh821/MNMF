...
args['DATA_DIR'] = ['wiki_n2v']# ,'washington', 'wisconsin', 'texas', 'cornell', 'ppi', 'wiki_n2v', 'cora', 'citeseer', 'wiki', 'armherst', 'hamilton', 'mich', 'rochester', 'blogcatalog']
...
pruned_hyper_params = wiki_n2v_pruned_hyper_params
