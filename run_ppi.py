...
args['DATA_DIR'] = ['ppi'] #'washington', 'wisconsin', 'texas', 'cornell', 'cora', 'citeseer', 'wiki', 'ppi', 'wiki_n2v', 'blogcatalog', 'armherst', 'hamilton', 'mich', 'rochester']
args['ETA'] = [1.0]
...
args['LAMBDA'] = [1.0]
args['K'] = [40, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60]
