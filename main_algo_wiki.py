...
def get_ArgumentParser():
    ...
    parser.add_argument("--DATA_DIR", default="wiki")
    ...
    parser.add_argument("--ALPHA", default=3.0, help="Similarity matrix factorization weight")
    ...
    parser.add_argument("--GAMMA", default=10.0, help="Modularity Maximization weight")
